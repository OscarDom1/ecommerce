                    ...
                    <form action="{{ url('/update_product_confirm', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="div_design">
                            ...
                            <input class="text_color" type="text" name="description"
                                placeholder="Write about the product " required="" value="{{ $product->description }}">
                        </div>

                        <div class="div_design">
                            <label for="">Product Price :</label>
                            <input class="text_color" type="number" name="price" placeholder="Write the price "
                        ...
                        <div class="div_design">
                            ...
                            <input class="text_color" type="number" name="dis_price"
                                placeholder="Write the discount price if applied " value="{{ $product->discount_price }}">
                        </div>

                        <div class="div_design">
                            <label for="">Product Quantity :</label>
                            <input class="text_color" type="number" min="0" name="quantity"
                                placeholder="Write the quantity " required="" value="{{ $product->quantity }}">
                        </div>
                        ...
                        <div class="div_design">
                            ...
                            <img style="margin: auto;" height="100" width="120"  src="/product/{{ $product->image }}" alt="">
                        </div>
